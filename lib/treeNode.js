 ...
 */
TreeNode.prototype.getChildrenByPattern = function (pattern) {
  var result = [];
  this.children.forEach(function (element) {
    if (pattern.test(element.path)) {
      result.push(element);
    }
  });
  return result;
 ...
 */
TreeNode.prototype.getFilesByPattern = function (pattern) {
  var result = [];
 ...
 */
TreeNode.prototype.getDirectoriesByPattern = function (pattern) {
  var result = [];
