...
describe('sync tests', function () {
  ...
  it('empty directory', function () {
    var tree = fto.createTreeSync(path.join(__dirname, '/fixtures/test1'));
   ...
   */
  it('directory with files', function () {
    var tree = fto.createTreeSync(path.join(__dirname, '/fixtures/test2'));
   ...
   */
  it('directory with files and sub directories', function () {
   ...
   * Test with directory that contains files and sub directories
   */
  it('large volume of directories and files loads ok', function () {
    var tree = fto.createTreeSync(path.join(__dirname, '../node_modules'));
   ...
   */
  it('bad directory', function () {
    var caughtErr = null;
    try {
      var tree = fto.createTreeSync(path.join(__dirname, '/fixtures/testx'));
    } catch (err) {
      caughtErr = err;
    }
